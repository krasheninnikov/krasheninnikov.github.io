...
title: "Liar’s poker: a card game you should try"
---
...
2. Flush is easier to guess than straight:
    ...
    Below is a plot of the chance of our bets being correct depending on the total number of cards in the game. As you can see, it is a good bit more likely that a bet on Flush would work out than a bet on Straight, for any number of cards in play.
