...
This is a simple tutorial that walks through the steps required to setup and use Anaconda environment for machine learning and reinforcement learning experiments. The tutorial does not assume any power user skills, and is optimized to be understandable to anyone.
